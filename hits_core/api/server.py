...
from .routes import health, work_log, node, handover, auth, knowledge, signal, checkpoint, task, ws, token, workflow, dag
...
class APIServer:
    ...
    def create_app(self) -> FastAPI:
        ...
        # --- WebSocket (no /api prefix — routes already include /ws) ---
