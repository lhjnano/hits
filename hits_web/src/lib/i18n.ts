...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'tasks.noMatchingTasks': 'No tasks match this filter.',
    ...
    'tasks.import': 'Import',
    'tasks.addChannel': 'Add Channel',
    'tasks.channelsConnected': 'channels connected',
    'tasks.noSlackConnection': 'No Slack connection — configure in Settings',
    'tasks.channelSettings': 'Channel Settings',
    'tasks.slackSettings': 'Slack Settings',
    'tasks.envDiff': 'Different environment — verify paths',
    'tasks.feedbackStarted': '🚀 Task started',
    'tasks.feedbackResumed': '▶ Task resumed',
    'tasks.feedbackStartFailed': 'Failed to start',
    'tasks.feedbackExported': '✅ Exported to {channel}',
    'tasks.feedbackImporting': '⏳ Importing...',
    'tasks.feedbackImported': '✅ Imported {count} from {channel}',
    'tasks.feedbackSignalSent': '✅ Signal sent + prompt copied for {tool}',
    'tasks.feedbackPromptCopied': '✅ Prompt copied — paste into {tool}',
    'tasks.readEnabled': '📥 Read enabled',
    'tasks.exportOnly': '📤 Export only',
    'tasks.advancedReadSettings': 'Advanced: Read (import) settings',
    'tasks.webhookPlaceholder': 'Webhook URL (for export)',
    'tasks.botTokenPlaceholder': 'Bot Token xoxb-... (for import)',
  },
  ...
  ko: {
    ...
    'tasks.noTasks': '일감이 없습니다. 하나 만들어 보세요!',
    'tasks.noMatchingTasks': '이 필터에 해당하는 일감이 없습니다.',
    'tasks.taskTitle': '제목',
    ...
    'tasks.status': '상태',
    'tasks.export': '내보내기',
    'tasks.exportTo': '내보낼 곳',
    'tasks.done': '완료',
    'tasks.reopen': '다시 열기',
    'tasks.edit': '편집',
    'tasks.editTask': '일감 편집',
    'tasks.all': '전체',
    'tasks.active': '진행 중',
    'tasks.pending': '대기 중',
    'tasks.inProgress': '작업 중',
    'tasks.startWork': '작업 시작',
    'tasks.import': '가져오기',
    'tasks.addChannel': '채널 추가',
    'tasks.channelsConnected': '개 채널 연결됨',
    'tasks.noSlackConnection': 'Slack 연결 없음 — 설정에서 구성',
    'tasks.channelSettings': '채널 설정',
    'tasks.slackSettings': 'Slack 설정',
    'tasks.envDiff': '다른 환경 — 경로를 확인하세요',
    'tasks.feedbackStarted': '🚀 작업 시작',
    'tasks.feedbackResumed': '▶ 작업 재개',
    'tasks.feedbackStartFailed': '시작 실패',
    'tasks.feedbackExported': '✅ {channel}에 내보냄',
    'tasks.feedbackImporting': '⏳ 가져오는 중...',
    'tasks.feedbackImported': '✅ {channel}에서 {count}개 가져옴',
    'tasks.feedbackSignalSent': '✅ {tool}에 시그널 전송 + 프롬프트 복사됨',
    'tasks.feedbackPromptCopied': '✅ 프롬프트 복사됨 — {tool}에 붙여넣으세요',
    'tasks.readEnabled': '📥 읽기 가능',
    'tasks.exportOnly': '📤 내보내기 전용',
    'tasks.advancedReadSettings': '고급: 읽기(가져오기) 설정',
    'tasks.webhookPlaceholder': 'Webhook URL (내보내기용)',
    'tasks.botTokenPlaceholder': 'Bot Token xoxb-... (가져오기용)',
  },
};
